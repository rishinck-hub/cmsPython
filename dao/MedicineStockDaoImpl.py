...
#     # SQL Query Templates
#     DISPLAY_ALL = "SELECT * FROM medicinestock"
#     INSERT_STOCK = (
#         "INSERT INTO medicinestock "
#         "(medicinestockid, stockhand, reorderlevel, purchase, issuance, medicineid) "
#         "VALUES (%s, %s, %s, %s, %s, %s)"
#     )
    ...
    # def update(self, stock: MedicineStock, stockid: int) -> bool:
    #     cursor = self.conn.cursor()
    #     try:
