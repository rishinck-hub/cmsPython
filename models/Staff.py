...
class Staff:
    ...
    def __str__(self):
     return (f"Staff ID: {self.__staffid}\tFull Name: {self.__fullname}\tGender: {self.__gender}\tBlood Group: {self.__bloodgroup}\tMobile No: {self.__mobileno}\tDOB: {self.__dob}\tUserName: {self.__username}\tPassword: {self.__password}\tRole ID: {self.__roleid}\tIs Active: {self.__isactive}")
